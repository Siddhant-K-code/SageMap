...
export const metadata: Metadata = {
  metadataBase: new URL('https://sagemap.netlify.app'),
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "SageMap - Map Your Evolving Beliefs",
      },
    ],
    locale: "en_US",
    type: "website",
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col items-center justify-center text-sm text-gray-600 gap-4">
              <div className="flex flex-col sm:flex-row items-center gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <a
                    ...
                    className="flex items-center gap-1 hover:text-gray-900 transition-colors"
                  >
                    <svg width="40" height="16" viewBox="0 0 71 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="flex items-center gap-2 text-xs">
                ...
                >
                  <img
                    src="/azure-ai-logo.png"
                    alt="Microsoft Azure"
                    className="w-6 h-6"
                  />
                  <span className="text-blue-600 font-medium">Azure AI</span>
                </a>
              </div>
            </div>
          </div>
